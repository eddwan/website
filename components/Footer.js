  ...
  return (
    <footer className="flex flex-col items-center mb-8">
      <div className="flex space-x-4 mb-4">
        <ExternalLink href="https://twitter.com/eddwanhallen">
        ...
        <ExternalLink href="https://github.com/eddwan">
        ...
        <ExternalLink href="https://www.linkedin.com/in/eddwan">
        ...
        <ExternalLink href="https://www.youtube.com/channel/UCkA2rpzr8nCPKqvqojveLkw">
        ...
        <ExternalLink href="mailto:me@eddwan.com">
